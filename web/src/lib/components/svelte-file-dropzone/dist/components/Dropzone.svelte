...
<div
  ...
  tabindex="0"
  role="button"
  class="flex flex-1 flex-col items-center p-20 border-2 border-dashed border-gray-300 dark:border-gray-300 rounded bg-gray-50 dark:bg-zinc-900 text-gray-400 dark:text-white outline-none transition duration-300 ease-in-out"
  {containerClasses}
